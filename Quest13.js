...
var favrt_mode_of_tranport_cars = ["Mazda", "Honda", "Alfa Romeo", "Tesla", "Volvo"];
for (var i = 0; i < favrt_mode_of_tranport_cars.length; i++) {
    console.log("I would like  to own  a " + favrt_mode_of_tranport_cars[i]);
}
